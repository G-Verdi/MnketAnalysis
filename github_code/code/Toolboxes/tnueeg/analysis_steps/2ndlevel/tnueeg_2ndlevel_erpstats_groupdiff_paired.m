...
for sub = 1: nSubjects
    scansConditions1       = fullfile(imagePaths{sub, 1}, ['smoothed_condition_' factorName '.nii,1']);
    scansConditions2       = fullfile(imagePaths{sub, 2},['smoothed_condition_' factorName '.nii,1']);
