function tnueeg_plot_grandmean_with_sem(gaData, titleStr, condNames, saveName, lineColors, lineWidth)
%TNUEEG_PLOT_GRANDMEAN_WITH_SEM Plots Grand Averages with shaded Error Bars
