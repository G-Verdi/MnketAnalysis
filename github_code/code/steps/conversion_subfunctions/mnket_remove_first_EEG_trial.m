function [ fileName ] = mnket_remove_first_EEG_trial( details, options )
%MNKET_REMOVE_FIRST_EEG_TRIAL Removes the first trial of a preprocessed, epoched EEG data set from
%the MNKET study. 
