function [ condlist ] = mnket_correct_conditions_for_eyeblinktrials( condlist, trialStatsFile )
%MNKET_CORRECT_CONDITIONS_FOR_EYEBLINKTRIALS Removes eyeblink trials from the condition list
