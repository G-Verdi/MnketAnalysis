...
%MNKET_2NDLEVEL_SINGLETRIAL_DRUGDIFF Computes the second level contrast images for differences in 
%the effects of single-trial (modelbased) regressors between drug conditions (placebo, ketamine) in 
%the MNKET study.
...
spmFile = fullfile(paths.statdifffold, regressorNames{1}, 'SPM.mat');
...
try
    ...
    scndlvlroot = paths.statdifffold;
