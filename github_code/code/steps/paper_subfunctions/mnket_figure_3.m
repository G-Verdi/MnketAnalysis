...
copyfile(fullfile(resultsDir, 'conF_sections', 'sections_F_plevel_FWE_p0.05_cluster1_k62.png'), ...
    figDir);
copyfile(fullfile(resultsDir, 'conF_contours', 'sections_F_plevel_FWE_p0.05_cluster1_k62.png'), ...
    figDir);
copyfile(fullfile(resultsDir, 'conF_scalpmaps', 'scalpmaps_spmF_0003_ft_cluster1_tw_184ms_to_184ms.png'), ...
    figDir);
...
copyfile(fullfile(resultsDir, 'conF_sections', 'sections_F_plevel_FWE_p0.05_cluster1_k59.png'), ...
    figDir);
copyfile(fullfile(resultsDir, 'conF_contours', 'sections_F_plevel_FWE_p0.05_cluster1_k59.png'), ...
    figDir);
