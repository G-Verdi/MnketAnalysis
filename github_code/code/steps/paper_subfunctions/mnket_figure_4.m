...
resultsDir = fullfile(paths.statdifffold, 'epsi2');
...
data.epsi2.peak = peak;
data.epsi2.tmax = tMax;
...
data.epsi3.peak     = con.clusters.peak;
data.epsi3.timewin  = con.clusters.timewin;
