function [ conf ] = mnCHR_configure_scalpmaps(con, options, flag, maxStatValue, peakSens)
%MNCHR_CONFIGURE_SCALPMAPS
%   IN:   con    -
%         options - 
%         flag    - 
%   OUT:  conf    -
...
% configure colorbars
col = colormap(options.fig.colmap);
col(1:7, :) = [];
