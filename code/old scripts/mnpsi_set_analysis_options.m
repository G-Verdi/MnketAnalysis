function options = mnpsi_set_analysis_options
...
switch uid(1: end-1)     
    ...
    case 'camh\gabrielle_allohverdi'
        options.maindir = ('C:\Users\gabrielle_allohverdi\Dropbox\PC\Documents\Cognemo\MN_PSI\psidata');
    otherwise
...
%-- condition info -------------------------------------------------------% 
options.condition   = 'placebo'; % 'placebo', 'ketamine', 'drugdiff','psilocybin'
options.conditions = {'placebo','psilocybin'};
%-- subject IDs ----------------------------------------------------------%

%------MNPSI Study Subjects-----------------------------------------------%
options.subjects.valid      = {'3621','4420','4421','4433','4332','4415','4418','4419' ...
                               '4426','4460', '4476', ...
                               '4502','4515','4518','4591','4592'};
options.subjects.pla        = {'4430','4508','4438'};
options.subjects.psi        = {'4448'};
options.subjects.all        = {'3621','4415','4418','4419','4420','4421','4426','4332','4433',...
                               '4448','4460','4476',...
                               '4502','4515','4518','4591','4592'};                           
%-- preparation ----------------------------------------------------------%
options.prepare.subjectIDs  = options.subjects.valid; % data preparation (tone sequences)
options.prepare.overwrite   = 1; % whether to overwrite any previous prep
                           
%-- modeling -------------------------------------------------------------%
options.model.subjectIDs    = options.subjects.valid; % modeling with the HGF
options.model.overwrite     = 1; % whether to overwrite any previous model

%-- preprocessing --------------------------------------------------------%
options.preproc.subjectIDs      = options.subjects.valid;
...
%-- erp ------------------------------------------------------------------%
options.erp.subjectIDs  = options.subjects.valid;                        
...
%-- conversion2images ----------------------------------------------------%
options.conversion.subjectIDs   = options.subjects.valid;
...
%-- stats ----------------------------------------------------------------%
options.stats.subjectIDs    = options.subjects.valid;
...
% options.eeg.stats.mode = options.stats.mode;
% options.eeg.stats.design = {'prediction', 'epsilon'};
% options.eeg.stats.regressors  = {'muhat2', 'muhat3','pihat'};
% options.groups.labels = {'pg','kg'};
% options.eeg.stats.secondlevel = {};
% options.groups.IDs{1,1}  = {'4431', '4446', '4447', '4458', ...
%                          '4482', '4487', '4488', '4548', ...
%                          '4494', '4499', '4500', '4520', ...
%                          '4532', '4497', '4534','4459','4507', '4422', '4478'};
% options.groups.IDs{1,2}  = {'3621','4415','4418','4419','4420',...
%                          '4421','4426','4332','4433',...
%                           '4448','4460','4476','4502',...
%                           '4515','4518','4591','4592'};
% options.conditions.labels = {'pla','drug'};
% options.conditions.IDs{1,1}  = {'4431', '4446', '4447', '4458', ...
%                                 '4482', '4487', '4488', '4548', ...
%                                 '4494', '4499', '4500', '4520', ...
%                                 '4532', '4497', '4534','4459','4507', '4422', '4478'};
% options.conditions.IDs{1,2}   = {'3621','4415','4418','4419','4420','4421','4426','4332','4433',...
%                                '4448','4460','4476',...
%                                '4502','4515','4518','4591',...
%                                '4592'};
% options.conditions.IDs{1,3}   = {'4431', '4446', '4447', '4458', ...
%                                 '4482', '4487', '4488', '4548', ...
%                                 '4494', '4499', '4500', '4520', ...
%                                 '4532', '4497', '4534','4459','4507', '4422', '4478'};
% options.conditions.IDs{1,4}   = {'3621','4415','4418','4419','4420','4421','4426','4332','4433',...
%                                '4448','4460','4476',...
%                                '4502','4515','4518','4591','4592'};
% options.groupxcond.labels     = {'pg_pla','pg_drug';'kg_pla','kg_drug'};
% options.groupxcond.IDs{1,1}   = {'3621','4415','4418','4419','4420','4421','4426','4332','4433',...
%                                '4448','4460','4476',...
%                                '4502','4515','4518','4591',...
%                                '4592'};
% options.groupxcond.IDs{1,2}   = {'3621','4415','4418','4419','4420','4421','4426','4332','4433',...
%                                '4448','4460','4476',...
%                                '4502','4515','4518','4591',...
%                                '4592'};
...
%                                 '4494', '4499', '4500', '4520', ...
%                                 '4532', '4497', '4534'};
% options.groupxcond.IDs{2,2}   = {'4431', '4446', '4447', '4458', ...
%                                 '4482', '4487', '4488', '4548', ...
%                                 '4494', '4499', '4500', '4520', ...
%                                 '4532', '4497', '4534'};                   
