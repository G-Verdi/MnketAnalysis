function [ peTrans ] = mnket_calculate_transitionPE( pe, tones )
%MNKET_CALCULATE_TRANSITIONPE Finds the PE on the current transition for each trial. Tones has one 
