function mn_2ndlevel_singletrial_activegroup(design, options)
%--------------------------------------------------------------------------
...
%                 if c == 1  
% 
%                     options.workdir = fullfile('/Volumes/Expansion/Cognemo/MMN/data/prj_epsi/test_mnket');
...
%                     
%                 elseif c==2
%                     options.workdir = fullfile('/Volumes/Expansion/Cognemo/MMN/data/prj_epsi/test_mnpsi');
%                     details = mn_subjects(temp{s}, options);
%                     % TODO: should be variable when source analysis is used and for ERP analysis
%                     icell(idx).scans{s, 1} = fullfile(details.statroot);
%                     
